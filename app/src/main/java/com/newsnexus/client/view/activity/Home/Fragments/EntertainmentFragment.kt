...
class EntertainmentFragment : Fragment(), HomeCategoriesCommunicator {
    ...
    companion object{
        ...
        fun newInstance(deliveredCategory: String?= null): EntertainmentFragment{
    ...
    private fun setUpView(){
        ...
        val appPreferences = this@EntertainmentFragment.requireActivity().getSharedPreferences(Constants.PREFERENCES.APP_PREFERENCES, Context.MODE_PRIVATE)
        ...
        homeViewModel.isLoading.observe(this@EntertainmentFragment.requireActivity(), {
        ...
        homeViewModel.isFail.observe(this@EntertainmentFragment.requireActivity(), {
            if(it){
                ...
                this@EntertainmentFragment.requireActivity().showPopupNotification(
                    ...
                    itemNewsAdapter = ItemNewsAdapter(
                        ...
                        object: ItemNewsAdapter.ItemListener{
                            override fun onItemClicked(item: Article) {
                                this@EntertainmentFragment.requireActivity().startActivity(
                                    DetailActivity.newIntent(
                                        this@EntertainmentFragment.requireActivity(),
                                        deliveredCategory!!,
                                        item
                                    )
                                )
                                this@EntertainmentFragment.requireActivity().overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
                            }
                        }
                    )

                    val myLayoutManager = LinearLayoutManager(this@EntertainmentFragment.requireActivity())
                    ...
                    addOnScrollListener(object: RecyclerView.OnScrollListener(){
                        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                            ...
                            if((visibleItemCount+firstVisibleItemPosition) >= totalItemCount
                                ...
                                homeViewModel.newsCollection2.observe(this@EntertainmentFragment.requireActivity(), {collectionNews2->
    ...
    override fun searchOnSelectedCategories(inputString: String) {
        ...
        homeViewModel.newsCollection2.observe(this@EntertainmentFragment, {collectionNews ->
            ...
            if(!collectionNews.articles.isNullOrEmpty()){
                ...
                Toast.makeText(this@EntertainmentFragment.requireActivity(), "Shows no result", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    override fun clearSearching() {
        currentPage = 1
        homeViewModel.getNewsCollectionMore(apiKey = retrievedToken!!, category = null, searchInput = null, page = currentPage!!)

        homeViewModel.newsCollection2.observe(this@EntertainmentFragment.requireActivity(), {collectionNews ->
            if(!collectionNews.articles.isNullOrEmpty()){
                itemNewsAdapter!!.updateItem(collectionNews.articles!!)
            }else{
                Toast.makeText(this@EntertainmentFragment.requireActivity(), "Couldn't fetch data", Toast.LENGTH_SHORT).show()
            }
        })
    }
