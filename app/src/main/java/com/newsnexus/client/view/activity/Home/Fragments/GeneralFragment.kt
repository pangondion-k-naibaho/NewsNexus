...
class GeneralFragment : Fragment(), HomeCategoriesCommunicator {
    ...
    companion object{
        ...
        fun newInstance(deliveredCategory: String?= null): GeneralFragment{
    ...
    private fun setUpView(){
        ...
        val appPreferences = this@GeneralFragment.requireActivity().getSharedPreferences(APP_PREFERENCES, Context.MODE_PRIVATE)
        ...
        homeViewModel.isLoading.observe(this@GeneralFragment.requireActivity(), {
            if(it) categoriesHomeCommunicator.startLoading() else categoriesHomeCommunicator.stopLoading()
        })

        homeViewModel.isFail.observe(this@GeneralFragment.requireActivity(), {
            if(it){
                categoriesHomeCommunicator.onPopUpStarted()
                this@GeneralFragment.requireActivity().showPopupNotification(
                    ...
                    listener = object: PopUpNotificationListener {
                        override fun onClickListener() {
                            this@GeneralFragment.requireActivity().closeOptionsMenu()
        ...
        homeViewModel.newsCollection.observe(this@GeneralFragment.requireActivity(), {collectionNews->
            binding.apply {
                rvItemNews.apply {
                    ...
                    val myLayoutManager = LinearLayoutManager(this@GeneralFragment.requireActivity())
                    ...
                    addOnScrollListener(object: RecyclerView.OnScrollListener(){
                        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                            ...
                            if((visibleItemCount+firstVisibleItemPosition) >= totalItemCount
                                ...
                                homeViewModel.newsCollection2.observe(this@GeneralFragment.requireActivity(), {collectionNews2->
    ...
    override fun searchOnSelectedCategories(inputString: String) {
        ...
        homeViewModel.newsCollection2.observe(this@GeneralFragment, {collectionNews ->
            ...
            if(!collectionNews.articles.isNullOrEmpty()){
                ...
                Toast.makeText(this@GeneralFragment.requireActivity(), "Shows no result", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    override fun clearSearching() {
        ...
        homeViewModel.newsCollection2.observe(this@GeneralFragment.requireActivity(), {collectionNews ->
            if(!collectionNews.articles.isNullOrEmpty()){
                itemNewsAdapter!!.updateItem(collectionNews.articles!!)
            }else{
                Toast.makeText(this@GeneralFragment.requireActivity(), "Couldn't fetch data", Toast.LENGTH_SHORT).show()
            }
        })
    }
