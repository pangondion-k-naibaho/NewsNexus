...
class ScienceFragment : Fragment(), HomeCategoriesCommunicator {
    ...
    private fun setUpView(){
        ...
        val appPreferences = this@ScienceFragment.requireActivity().getSharedPreferences(Constants.PREFERENCES.APP_PREFERENCES, Context.MODE_PRIVATE)
        ...
        homeViewModel.isFail.observe(this@ScienceFragment.requireActivity(), {
            if(it){
                ...
                this@ScienceFragment.requireActivity().showPopupNotification(
