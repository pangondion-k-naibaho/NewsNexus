...
class HealthFragment : Fragment(), HomeCategoriesCommunicator {
    ...
    private fun setUpView(){
        ...
        val appPreferences = this@HealthFragment.requireActivity().getSharedPreferences(Constants.PREFERENCES.APP_PREFERENCES, Context.MODE_PRIVATE)
        ...
        homeViewModel.isFail.observe(this@HealthFragment.requireActivity(), {
            if(it){
                ...
                this@HealthFragment.requireActivity().showPopupNotification(
